    ...
    this.innerHTML = `
        <div id="about-us" class="bg-light_gray">
            <div class="flex flex-col md:flex-row items-center w-co m-auto py-11">
                <div class="w-full md:w-1/4 max-h-20 min-h-15 md:order-2 mb-8 md:mb-0" data-aos="fade-left" data-aos-duration="1000">
                    <img src="${aboutimg}" class="max-h-20 m-auto"></img>
                </div>
                <div class="w-full md:w-3/4 md:mr-7 md:order-1" data-aos="fade-right" data-aos-duration="1200">
